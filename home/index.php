...
$sqlUserCheck = "SELECT * FROM `url_master` WHERE `url` = '$url'";
...
$chatExists = mysqli_num_rows($queryRun);
        ...
        if ($chatExists == 1) {
            while ($row = mysqli_fetch_array($queryRun)) {
                if($row['status'] == "Block"){
                    header("location: http://" . $servername . "/PHP_Project/admin/pages/samples/block.html");
                }
            }
            
        } else {
            $sql = "INSERT INTO `url_master` (`url`, `status`, `live`) VALUES ('$url', 'loading', '8')";
...
<head>
    ...
    <link rel="stylesheet" href="http://localhost:90/PHP_Project/css/bootstrap.min.css" integrity="sha384-Gn5384xqQ1aoWXA+058RXPxPg6fy4IWvTNh0E263XmFcJlSAwiGgFAW/dAiS6JXm" crossorigin="anonymous">

    <script src="http://localhost:90/PHP_Project/css/jquery-3.2.1.slim.min.js" integrity="sha384-KJ3o2DKtIkvYIK3UENzmM7KCkRr/rE9/Qpg6aAZGJwFDMVNA/GpGFF93hXpG5KkN" crossorigin="anonymous"></script>
    <script src="http://localhost:90/PHP_Project/css/popper.min.js" integrity="sha384-ApNbgh9B+Y1QKtv3Rn7W3mgPxhU9K/ScQsAP7hUibX39j7fakFPskvXusvfa0b4Q" crossorigin="anonymous"></script>
    <script src="http://localhost:90/PHP_Project/css/bootstrap.min.js" integrity="sha384-JZR6Spejh4U02d8jOt6vLEHfe/JQGiRRSQQxSfFWpi1MquVdAyjUar5+76PVCmYl" crossorigin="anonymous"></script>
    <title>Chat</title>
</head>
<style>
    html {
...
<body>
    ...
    <script>
        ...
        function messageCheck() {
            $.post("http://localhost:90/PHP_Project/dispmsg.php", {
                    url: "<?php echo $url ?>"
                },
        ...
        $(document).ready(function() {
            ...
            $("#submitMsg").click(function() {
                ...
                $.post("http://localhost:90/PHP_Project/send.php", {
                        text: clientmsg,
