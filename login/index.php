...
if ((isset($_SESSION['loggedin']) && $_SESSION['loggedin'] == true)) {
	header("location:http://" . $server . "/PHP_Project/home/index.php?url=" . $url);
	exit;
}
...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
	...
	if ($userExists == 1) {
		...
		// 	echo "url unset";
		// }
		header("location:http://localhost:90/PHP_Project/steps.html");  //Put url of introduction page
	} else {
				...
				<div class="col-md-6 col-lg-5">
					<div class="login-wrap p-4 p-md-5">
						...
						<h3 class="text-center mb-4">
							<a href="http://localhost:90/PHP_Project/signup/signup.php">Don't have an account?</a>
						</h3>
						<form action="index.php" class="login-form" method="POST" autocomplete="off">
